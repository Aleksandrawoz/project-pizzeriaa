...
/* eslint-disable no-undef */ ! function (t, e) { 'object' == typeof exports && 'object' == typeof module ? module.exports = e() : 'function' == typeof define && define.amd ? define('rangeSlider', [], e) : 'object' == typeof exports ? exports.rangeSlider = e() : t.rangeSlider = e(); }(window, function () {
  return function (i) {
    var n = {};

    function s(t) { if (n[t]) return n[t].exports; var e = n[t] = { i: t, l: !1, exports: {} }; return i[t].call(e.exports, e, e.exports, s), e.l = !0, e.exports; } return s.m = i, s.c = n, s.d = function (t, e, i) { s.o(t, e) || Object.defineProperty(t, e, { enumerable: !0, get: i }); }, s.r = function (t) { 'undefined' != typeof Symbol && Symbol.toStringTag && Object.defineProperty(t, Symbol.toStringTag, { value: 'Module' }), Object.defineProperty(t, '__esModule', { value: !0 }); }, s.t = function (e, t) {
      if (1 & t && (e = s(e)), 8 & t) return e; if (4 & t && 'object' == typeof e && e && e.__esModule) return e; var i = Object.create(null); if (s.r(i), Object.defineProperty(i, 'default', { enumerable: !0, value: e }), 2 & t && 'string' != typeof e)
        for (var n in e) s.d(i, n, function (t) { return e[t]; }.bind(null, n)); return i;
    }, s.n = function (t) { var e = t && t.__esModule ? function () { return t.default; } : function () { return t; }; return s.d(e, 'a', e), e; }, s.o = function (t, e) { return Object.prototype.hasOwnProperty.call(t, e); }, s.p = '', s(s.s = 1);
  }([function (_t, e, _i) {
    'use strict';
    ...
    e.getFirsNumberLike = function () {
      for (var t = arguments.length, e = Array(t), i = 0; i < t; i++) e[i] = arguments[i]; if (!e.length) return null; for (var n = 0, s = e.length; n < s; n++)
        if (r(e[n])) return e[n];
      return null;
    }, e.isObject = function (t) { return '[object Object]' === Object.prototype.toString.call(t); }, e.simpleExtend = function (t, e) { var i = {}; for (var n in t) i[n] = t[n]; for (var s in e) i[s] = e[s]; return i; }, e.between = function (t, e, i) { return t < e ? e : i < t ? i : t; };
  }, function (t, e, i) {
    'use strict';
    ...
    i(3); var o = new RegExp('/[\\n\\t]/', 'g'),
      ...
      a = function () {
        function a(t, e) {
          ! function (t, e) { if (!(t instanceof e)) throw new TypeError('Cannot call a class as a function'); }(this, a); var i = void 0,
            n = void 0,
            s = void 0; if (a.instances.push(this), this.element = t, this.options = h.simpleExtend(f, e), this.polyfill = this.options.polyfill, this.vertical = this.options.vertical, this.onInit = this.options.onInit, this.onSlide = this.options.onSlide, this.onSlideStart = this.options.onSlideStart, this.onSlideEnd = this.options.onSlideEnd, this.onSlideEventsCount = -1, this.isInteractsNow = !1, this.needTriggerEvents = !1, this._addVerticalSlideScrollFix(), this.polyfill || !d) {
        ...
        } return n(a, [{ key: 'update', value: function (t, e) { return e && (this.needTriggerEvents = !0), h.isObject(t) && (h.isNumberLike(t.min) && (this.element.setAttribute('min', '' + t.min), this.min = t.min), h.isNumberLike(t.max) && (this.element.setAttribute('max', '' + t.max), this.max = t.max), h.isNumberLike(t.step) && (this.element.setAttribute('step', '' + t.step), this.step = t.step, this.toFixed = this._toFixed(t.step)), h.isNumberLike(t.buffer) && this._setBufferPosition(t.buffer), h.isNumberLike(t.value) && this._setValue(t.value)), this._update(), this.onSlideEventsCount = 0, this.needTriggerEvents = !1, this; } }, {
          ...
          key: '_startEventListener', value: function (t, e) {
            var i = this,
              n = t.target,
              s = !1;
            (1 === t.which || 'touches' in t) && (l.forEachAncestors(n, function (t) { return s = t.id === i.identifier && !l.hasClass(t, i.options.disabledClass); }, !0), s && this._handleDown(t, e));
          }
        }, {
          ...
          key: '_setBufferPosition', value: function (t) {
            var e = !0; if (isFinite(t)) t = parseFloat(t);
            else {
          ...
          key: '_getValueFromPosition', value: function (t) {
            var e = t / (this.maxHandleX || 1),
              i = this.step * Math.round(e * (this.max - this.min) / this.step) + this.min; return Number(i.toFixed(this.toFixed));
          }
        }, {
          ...
          key: 'create', value: function (t, i) {
            ...
            t.length ? Array.prototype.slice.call(t).forEach(function (t) { e(t); }) : e(t);
          }
        }, { key: '_touchMoveScrollHandler', value: function (t) { a.slidingVertically && t.preventDefault(); } }]), a;
      }();
    ...
    Object.defineProperty(e, '__esModule', { value: !0 }), e.supportsRange = e.removeAllListenersFromEl = e.removeEventListeners = e.addEventListeners = e.insertAfter = e.triggerEvent = e.forEachAncestors = e.removeClass = e.addClass = e.hasClass = e.setCss = e.getDimension = e.getHiddenParentNodes = e.isHidden = e.detectIE = void 0; var s = function (t) {
      ...
      l = (e.getDimension = function (t, e) {
        var i = h(t),
          ...
          s = [],
          r = t[e],
          o = function (t) { void 0 !== t.open && (t.open = !t.open); }; if (n) {
          for (var a = 0; a < n; a++) s.push({ display: i[a].style.display, height: i[a].style.height, overflow: i[a].style.overflow, visibility: i[a].style.visibility }), i[a].style.display = 'block', i[a].style.height = '0', i[a].style.overflow = 'hidden', i[a].style.visibility = 'hidden', o(i[a]);
          r = t[e]; for (var l = 0; l < n; l++) o(i[l]), i[l].style.display = s[l].display, i[l].style.height = s[l].height, i[l].style.overflow = s[l].overflow, i[l].style.visibility = s[l].visibility;
        } return r;
      }, e.setCss = function (t, e) { for (var i in e) t.style[i] = e[i]; return t.style; }, e.hasClass = function (t, e) { return new RegExp(' ' + e + ' ').test(' ' + t.className + ' '); });
    e.addClass = function (t, e) { l(t, e) || (t.className += ' ' + e); }, e.removeClass = function (t, e) {
    ...
    }, e.forEachAncestors = function (t, e, i) { for (i && e(t); t.parentNode && !e(t);) t = t.parentNode; return t; }, e.triggerEvent = function (t, e, i) {
      if (!s.isString(e)) throw new TypeError('event name must be String'); if (!(t instanceof HTMLElement)) throw new TypeError('element must be HTMLElement');
      e = e.trim(); var n = document.createEvent('CustomEvent');
      n.initCustomEvent(e, !1, !1, i), t.dispatchEvent(n);
    }, e.insertAfter = function (t, e) { return t.parentNode.insertBefore(e, t.nextSibling); }, e.addEventListeners = function (e, t, i) { t.forEach(function (t) { e[r] || (e[r] = {}), e[r][t] || (e[r][t] = []), e.addEventListener(t, i, o), e[r][t].indexOf(i) < 0 && e[r][t].push(i); }); }, e.removeEventListeners = function (i, t, n) {
      ...
      function n(t) { t === e._startEventListener && this.el.removeEventListener(this.eventName, t, !1); }
